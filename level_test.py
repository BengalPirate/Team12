...
while True:
    ...
    if game_active:
        # the levels_data is a dictionary and starts witha  key value of 0
        # so chosen_lvl start at 0
        chosen_lvl = 0
        generate_lvl = Level(levels_data,chosen_lvl)
        
        color_black = (0, 0, 0)
        display.fill((84, 12, 123))
        start_level = text_font.render('Press Enter to Start Level', False, color_black)
        start_level_rect = header_text.get_rect(center=(800 // 2, 50))
        display.blit(start_level, start_level_rect)
        ...
        if start_next_level:
            ...
            while level_complete != True:
                ...
                while not level_complete:  
                    ...
                    if generate_lvl.is_complete_status(enemies):
                        level_complete = True
