...
selection_menu_font = pygame.font.Font('fonts/Pixeltype.ttf', selection_menu_font_size)
logo = pygame.image.load('Title2.png')  # replace with the path to your logo
...
for i in range(1, num_images + 1):
    image_path = f'menu/start_menu/start_menu{i}.png'
...
credits_background = pygame.image.load('menu/credits/credits1.png')
controls_background = pygame.image.load('menu/controls/controls1.png')
game_over_background = pygame.image.load('menu/game_over/game_over1.png')
